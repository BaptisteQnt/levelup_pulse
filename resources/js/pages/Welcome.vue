            ...
            <main class="flex w-full max-w-[335px] flex-col-reverse overflow-hidden rounded-lg lg:max-w-4xl lg:flex-row">
                ...
                >
                    ...
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                        LevelUp has an incredibly rich ecosystem. <br />We suggest starting with the following.
                    </p>
                ...
                >
                    <div class="flex h-full w-full items-center justify-center p-10">
                        <img
                            class="duration-750 starting:translate-y-6 starting:opacity-0 w-full max-w-xs translate-y-0 opacity-100 transition-all"
                            src="/images/logo-levelup.png"
                            alt="LevelUp logo"
                        />
                    </div>
                    <div
